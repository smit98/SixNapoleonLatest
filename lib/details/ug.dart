...
class UG extends StatefulWidget {
  UGState createState() => new UGState();
}

class UGState extends State<UG> with SingleTickerProviderStateMixin {
  ...
  Widget _build_Menu_Bar(BuildContext context) {
    return Container(
      width: 300.0,
      height: 50.0,
      decoration: BoxDecoration(
  ...
  Widget _build_Sign_Up(BuildContext context) {
    return Container(
      padding: EdgeInsets.only(top: 0.0),
      child: Column(
        children: <Widget>[
